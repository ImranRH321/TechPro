        ...
        <div className='my-10'>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 ">
                <div className="text-left p-3">
                    ...
                    <h1 className='md:text-3xl lg:text-4xl font-bold mt-3 text-2xl'>Leading global technical service provider</h1>
                ...
                <div className=" border2">
                  <div className="background_img mx-auto md:flex justify-center items-center">
                   <img className='w-3/5 mx-auto md:w-full lg:w-4/5' src={bImg} alt="noIMg" />
                  </div>
                </div>
            </div>
        </div>
